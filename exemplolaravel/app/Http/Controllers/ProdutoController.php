...
class ProdutoController extends Controller
{
    ...
    public function pesquisarEntreValores(Request $request){ 
        $produtos = Produto::whereBetween('valor', 
        [$request->valorInicial, $request->valorFinal])->get();
    ...
    public function pesquisarMarca(Request $request)
    {
     ...
     public function pesquisarPorMonth(Request $request)
    {
        $produtos = Produto::whereMonth('marca', '=', $request->mes)->get();
        if ($produtos->isEmpty()) {
            return response()->json([
                'status' => false,
                'message' => 'Sem resultados para a pesquisa'
...
/* 
criar controller: 
php artisan make:controllerClienteController
php artisan make:controller ServicoController
